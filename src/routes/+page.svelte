	...
	const jsonLd = `<script type="application/ld+json">${JSON.stringify({
		...
		'@graph': [
			...
			},
			{
				...
				name: 'OpenPlan3D',
				url: 'https://openplan3d.com/capture',
				downloadUrl: OPENPLAN_APP_STORE,
...
<div class="page">
	...
	<section class="hero">
		...
		<div class="hero-btns">
			...
			<a class="btn btn-ghost" href={OPENPLAN_APP_STORE} onclick={() => trackOutbound('hero_app_store', OPENPLAN_APP_STORE)}>Download on the App Store</a>
		</div>
	...
	<section id="capture" class="section section-alt two-col">
		<div class="col-text">
			...
			<div class="col-btns">
				<a class="btn btn-navy-lg" href={OPENPLAN_APP_STORE} onclick={() => trackOutbound('capture_section_app_store', OPENPLAN_APP_STORE)}>
				...
				<a href="/capture">Explore the iPhone app →</a>
			</div>
		</div>
	...
	<section class="cta">
		...
		<div class="hero-btns">
			...
			<a class="btn btn-ghost" href={OPENPLAN_APP_STORE} onclick={() => trackOutbound('homepage_bottom_app_store', OPENPLAN_APP_STORE)}>Download on the App Store</a>
		</div>
	</section>
</div>
